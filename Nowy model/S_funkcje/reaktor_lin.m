function [sys,x0,str,ts,simStateCompliance] = reaktor_lin(t,x,u,flag)
...
%
x0 = [1.0 4625.71 1488.75 548.303 557.106 1506.38 565.909 575.711 1523.96 583.514 592.5 592.5 592.5 539.5 539.5];
...
delta_P_cor = Pcor - Pcor0;
delta_ro = ROH - ROH0;
delta_C = C - C0;
DPcor = ((ROH0-BETAt)/NGT)*delta_P_cor + (Pcor0/NGT)*delta_ro + LANDA*delta_C;
xdot(1) = DPcor;
